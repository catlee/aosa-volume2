...
\code{select}. This gives us all the performance of an event-based IO
...
\item \code{toHtml} will automatically escape any entities. So if a user
  submits the string \code{{\textless}script src="http://example.com/evil.js"{\textgreater}{\textless}/script{\textgreater}}, the less
...
of the \code{getEntryR} function would be:
