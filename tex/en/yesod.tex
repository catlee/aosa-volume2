...
\begin{verbatim}
type Application = Request -> Iteratee ByteString I/O Response
\end{verbatim}

The \code{I/O} simply explains what types of side effects an application can
perform. In the case of \code{I/O}, it can perform any kind of interaction
