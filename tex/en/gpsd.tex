...
well-known TCP/IP port.  Other programs in the suite include both
...
service. It's even used in the Identfication-Friend-or-Foe system of
...
etc.  Auxilary methods may support driver control operations, such as
