...
%% QUERY: Added "and" before "the inital LDFLAGS" below; is that correct? --ARB
for various \code{rootfs} directories, and the initial \code{LDFLAGS} to be used during
