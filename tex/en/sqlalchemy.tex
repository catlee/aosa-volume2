...
\aosafigure{../images/sqlalchemy/layers.pdf}{SQLAlchemy layer diagram}{fig.sqlalchemy.layers}
...
\aosafigure{../images/sqlalchemy/engine.pdf}{Engine, Connection, ResultProxy API}{fig.sqlalchemy.engine}
...
\aosafigure{../images/sqlalchemy/table-column-crossover.pdf}{The dual lives of Table and Column}{fig.sqlalchemy.crossover}
...
\aosafigure{../images/sqlalchemy/example-expression.pdf}{Example expression tree}{fig.sqlalchemy.tree}
...
\aosafigure[250pt]{../images/sqlalchemy/compiler-hierarchy.pdf}{Compiler hierarchy, including PostgreSQL-specific implementation}{fig.sqlalchemy.compiler}
...
\aosafigure{../images/sqlalchemy/mapper-components.pdf}{Anatomy of a mapping}{fig.sqlalchemy.anatomy}
...
\aosafigure{../images/sqlalchemy/query-loading.pdf}{Traversal of loader strategies including a joined eager load}{fig.sqlalchemy.loading}
...
\aosafigure[250pt]{../images/sqlalchemy/uow-mapper-buckets.pdf}{Organizing objects by mapper}{fig.sqlalchemy.organizing}
...
\aosafigure[250pt]{../images/sqlalchemy/uow-element-buckets.pdf}{Organizing reference cycles into individual steps}{fig.sqlalchemy.cyclesteps}
