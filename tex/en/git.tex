...
%% QUERY: I'm not sure of the meaning of the verb "fail" in this sentence.
%% Will our readers know what you mean? If not can you please reword the
%% sentence? --ARB
...
\begin{aosaitemize}
  ...
  ready to share.
%% QUERY: Make sure rewording of following point is correct. --ARB
...
%% QUERY: You haven't introduced the RCS family - can you define this
%% term briefly, like: "the RCS family, the group of VCSs based on GNU's RCS."
%% (Or whatever it actually means!) --ARB
...
%%% QUERY: Greg, which words should be in \code{}: HEAD? trunk? master? --ARB
...
%% QUERY: I don't think you mean "that" in the previous sentence, but I don't 
%% know what you did mean. Can you please rewrite the previous sentence? --ARB
