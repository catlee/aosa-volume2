...
community in 2005. At that time the Linux kernel codebase had been managed
across two VCS systems (BitKeeper and CVS) for a few years already.
...
These original goals have been accomplished and maintained as I will attempt
to show when dissecting Git's use of DAGs for content storage, its object
model representatation, its remote protocol and how it tracks the merging
of trees.
