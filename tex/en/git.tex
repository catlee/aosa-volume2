...
\emph{Note: The third requirement above isn't a functional requirement for
all VCSs.}
...
blobs (reusing existing blob references where the files content hasn't
...
In the Subversion scenario the collaborator didn't have to remember
