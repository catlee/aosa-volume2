...
%% QUERY: I'm not sure "performant" is the word you want here - it has
%% to do with speed/efficiency. I'm thinking a synonym for "useful"
%% is more appropriate: functional, serviceable, worthwhile, productive,
%% valuable... --ARB
...
%% QUERY: This image relies on colour for meaning - can you make a version which
%% doesn't? Also, can you change the label on "Asynchronous" to "Event-driven"? --ARB
...
%% QUERY: In your original chapter you have a footnote marker after "merge" but 
% no footnote. Do you remember what you meant to link to here? --ARB
