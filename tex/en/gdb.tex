...
consult the symbol table to find out that \code{positive_variable} is a
...
\begin{aosasect1}{Open Development Wins}
...
\begin{aosasect1}{Don't Get Too Attached to the Code}
