...
consult the symbol table to find out that \code{positive\_variable} is
an integer global variable that is stored at, say, memory address
\code{0x658932}.  It then calls a target-side function to read the
...
figured out using \code{autoconf}.
