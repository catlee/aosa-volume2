...
\code{mylist@example.org}, then the VERP-encoded envelope sender for a
mailing list posting sent to \code{anne@example.com} will be
...
%% QUERY: Can you add a short description of Canonical here: "hired
%% by Canonical, a company which provides support and services to
%% the Ubuntu community, in 2007..." Something like that. --ARB
with external systems.  When I was hired by Canonical in 2007, my job
%% QUERY: Is this description of Launchpad okay? --ARB
...
%% QUERY: You say "back to bytes" at the end of this sentence, but it's
%% not clear that you converted FROM bytes at the beginning of the sentence.
%% Can you clarify?  --ARB
