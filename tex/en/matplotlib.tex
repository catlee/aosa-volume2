...
%% QUERY: Should we capitalize "matplotlib" in the title of the chapter? 
%% What about elsewhere (i.e., at the beginning of sentences)?  --ARB
...
\aosafigure{../images/matplotlib/histogram_demo.pdf}{A histogram created using pyplot.}{fig.matplotlib.hist}
...
\aosafigure[250pt]{../images/matplotlib/pixel_snapping.pdf}{A close-up view of the effect of pixel snapping.  On the left, without pixel snapping; on the right, with pixel snapping.}{fig.matplotlib.pixelsnapping}
