...
of that data at random. (\aosafigref{fig.distsys.7}) 
...
off disk once. (\aosafigref{fig.distsys.14}) There is some cost associated with this design, since
...
bigB, greatly minimizing the reads from the data origin. (\aosafigref{fig.distsys.15}) This can make
...
you get the specific piece of data you want. (\aosafigref{fig.distsys.17})
...
service the same function in a system. (\aosafigref{fig.distsys.18}) Their main purpose is to handle
...
the capacity to process it. (\aosafigref{fig.distsys.21}) These tasks 
