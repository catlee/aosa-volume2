...
\code{LATEST}, that means generating updates for every platform, every locale,
and every installer from Firefox \code{LATEST-1}, \code{LATEST-2},
\code{LATEST-3}, {\ldots} in both complete and partial forms. We do all this
...
%% FIXME: We will need to add line breaks here. --ARB Greg, does this look okay?
\begin{figure}  
\begin{verbatim}
<updates>
