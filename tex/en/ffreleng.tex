...
\aosafigure{../images/ffreleng/gotobuild.png}{Getting From Code to ``Go to build''}{fig.ffreleng.getting}
...
In \aosafigref{fig.releng.repack}, you can see that we currently rely
...
\aosafigure{../images/ffreleng/signing.png}{Signing Firefox Installers}{fig.ffreleng.signing}
