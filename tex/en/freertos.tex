...
%% FIXME: In the pdf, the layers figure is right on top of the code snippet, and the "Figure 3.1 FreeRTOS software layers" looks like it might apply to either the figure or the code. Can we move the figure to be right under this paragraph (above) so it is separate from the code snippet? --CS

\aosafigure[250pt]{../images/freertos/freertos-figures-layers.png}{FreeRTOS software layers}{fig.freertos.layers}
...
%% FIXME: Can we get the paragraph immediately above and the entire snippet below on the same page? Currently the pdf has a page break in the middle of the snippet. --CS
...
\aosafigure[325pt]{../images/freertos/freertos-figures-basic-ready-list.png}{Basic view of FreeRTOS Ready List}{fig.freertos.ready}

%% FIXME: the arrows at the bottom of that png file that point to Task B, C and D
%% are crooked in the pdf. But when I look at the png itself the arrows are straight.
%% Will they be straight in the final printing? --CS
...
\aosafigure[325pt]{../images/freertos/freertos-figures-full-ready-list.png}{Full view of FreeRTOS Ready List}{fig.freertos.list}

%% FIXME: the arrow at the bottom of that png file that point from pxCurrentTCB to
...
\aosafigure[325pt]{../images/freertos/freertos-figures-full-ready-list-2.png}{Full view of FreeRTOS Ready List after a system timer tick}{fig.freertos.aftertick}
%% FIXME: the arrow at the bottom of that png file that point from pxCurrentTCB to
...
%% FIXME: The page breaks around the two previous figures and the queue
