...
connections to the \code{worker}s. Upon startup, an initial set of
...
%% QUERY: Can you give a source for this quote? Is it from a blog
%% post, from a newsgroup posting, a personal email...? --ARB
