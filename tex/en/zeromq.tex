...
variables. \aosafigref{fig.zeromq.multiuse} shows ØMQ library being
used from two different and independent libraries. The application
then uses both of those libraries.

\aosafigure{../images/zeromq/aosa1.png}{0MQ Being Used From Different Libraries}{fig.zeromq.multiuse}
...
\aosafigure{../images/zeromq/aosa8.png}{Sending a Message from A to B}{fig.zeromq.a2b}
...
\aosafigure{../images/zeromq/aosa2.png}{Message Copying (or Not)}{fig.zeromq.ref}
...
\aosafigure{../images/zeromq/aosa3.png}{Sending Four Messages}{fig.zeromq.send4}
...
\aosafigure{../images/zeromq/aosa4.png}{Joining Messages}{fig.zeromq.joinmessage}
...
\aosafigure{../images/zeromq/aosa9.png}{0MQ Architecture}{fig.zeromq.arch}
...
\aosafigure{../images/zeromq/aosa5.png}{Caching}{fig.zeromq.cache}
...
\aosafigure{../images/zeromq/aosa6.png}{Queues}{fig.zeromq.multiqueue}
...
\aosafigure{../images/zeromq/aosa7.png}{Flushing}{fig.zeromq.flush}
